...
export function findColumn(headers: string[], possibleNames: string[]): number {
...
export function findAnyColumn(headers: string[], lists: string[][]): number {
 ...
 */
export function parseAmount(value: string, config: BankConfig): number {
